      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Bring your business to Gurgaon with a Virtual Office</h1>
            <p className="text-xl mb-8">Set-up a virtual office in prime locations all across Gurgaon and enjoy premium services of a real office space.</p>
            
            {/* Mobile Form */}
            <div className="bg-white p-6 rounded-lg shadow-lg text-gray-800 mb-8 lg:hidden">
              <h3 className="text-xl font-bold mb-4">Know more about Virtual office in Gurgaon</h3>
              <p className="text-gray-600 mb-4">Stress free registrations guaranteed with myHQ</p>
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div className="floating-label relative">
                  <input 
                    ...
                    required
                  />
                  <label className="absolute left-0 top-3 text-gray-500 transition-all duration-200 pointer-events-none">Name</label>
                </div>
                <div className="floating-label relative">
                  <input 
                    type="tel" 
                    ...
                    required
                  />
                  <label className="absolute left-0 top-3 text-gray-500 transition-all duration-200 pointer-events-none">Mobile number</label>
                </div>
                <div className="floating-label relative">
                  <input 
                    type="email" 
                    ...
                    required
                  />
                  <label className="absolute left-0 top-3 text-gray-500 transition-all duration-200 pointer-events-none">Email</label>
                </div>
          ...
          <div className="lg:w-1/2">
            <div className="sticky top-4 hidden lg:block">
              <div className="bg-white p-8 rounded-lg shadow-lg text-gray-800">
                <h3 className="text-2xl font-bold mb-2">Know more about Virtual office in Gurgaon</h3>
                <p className="text-gray-600 mb-6">Stress free registrations guaranteed with myHQ</p>
